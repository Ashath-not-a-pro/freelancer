...
const MainContainer = () => {
  ...
  const icons = [
    <CirclePlus onClick={() => router.push("/addpost")} />,
    <CircleUser onClick={() => router.push("/dashboard")} />,
  ];
  return (
    <div>
      ...
      <div>
        {hasList ? (
          ...
          <div className="text-gray-700 text-center flex items-center">no data found</div>
        )}
      </div>
    </div>
  );
